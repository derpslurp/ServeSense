...
```
   ...
   To have edits in the **ai/** folder (project root) reload without restarting, either:

   - Run from **backend**: `python -m app.main` (watches both backend and ai), or  
   - Use: `uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload --reload-dir . --reload-dir ..`
